...
- Docker Hub Login — Authenticates using jtlistakes and the  
...
- Conditional push — Builds on all triggers but only pushes to Docker
  ...
  │ Workflow │ Image │  
  ├─────────────────────┼────────────────────────────────┤  
  │ llm-multiroute │ jtlistakes/llm-multiroute │  
  ├─────────────────────┼────────────────────────────────┤  
  │ llm-frontend-python │ jtlistakes/llm-frontend-python │  
  └─────────────────────┴────────────────────────────────┘  
  Required secret
  Add this in your repo settings (Settings > Secrets and variables > Actions):
  Secret: DOCKERHUB_TOKEN
  Purpose: Docker Hub access token for jtlistakes (generate at https://hub.docker.com/settings/security)
